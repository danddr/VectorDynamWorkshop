...
<section>
    ...
    <p>The processed observations are openly accessible through the <a target="_blank" href="https://doi.org/10.5281/zenodo.11486198">VectAbundance Zenodo repository</a>. For further details on the methodology and applications, refer to the related scientific publication in Scientific Data: <a href="https://www.nature.com/articles/s41597-024-03482-y" target="_blank">"VectAbundance: a spatio-temporal database of Aedes mosquitoes observations"</a>.</p>
    
    <h4>VectorByte</h4>
    <p> <a href="https://www.vectorbyte.org" target="_blank">VectorByte</a> is a global open-access data platform designed to support research on disease vectors. The initiative serves as a hub for biological trait (VecTraits) and abundance (VecDyn) data for both human and non-human disease vectors. In addition, it offers a suite of analytical tools and training resources to researchers and public health practitioners worldwide.</p>
    
    <h4>VectorBase</h4>
    <p>
    <a href="https://vectorbase.org/vectorbase/app/" target="_blank">VectorBase</a> is a key Bioinformatics Resource Center (BRC) funded by the National Institute of Allergy and Infectious Diseases (NIAID), part of the National Institutes of Health (NIH). It focuses on invertebrate vectors of human pathogens, working in collaboration with sequencing centres and the research community to curate and annotate vector genomes. VectorBase plays an essential role in advancing vector genomics for public health research.</p>
</section>
...
<section>
    ...
    <p>Access the scripts here: <a href="https://github.com/download_ERA5-Land">GitHub - download_ERA5-Land</a></p>
    ...
    <p>microclima is particularly suited for understanding how small-scale environmental factors influence temperature patterns. An explanatory R script for the package is available at <a href="https://github.com/microclima">GitHub - microclima</a>.</p>
</section>
...
<h3>arbocartoR</h3>
    ...
    <p>Useful resources:
        <ul>
            <li>The source code is available at <a href="https://forgemia.inra.fr/umr-astre/arbocartoR">Github</a></li>
            <li>The web interface is available at <a href="https://arbocarto-r-app.sk8.inrae.fr/">arbocartoR web interface</a></li>
            <li>Visit the <a href="https://www.arbocarto.fr/en/arbocartor">arbocarto website</a> for more information</li>
        </ul>
    </p>

    <h3>dynamAedes</h3>
    <p>
        <a href="https://parasitesandvectors.biomedcentral.com/articles/10.1186/s13071-024-06121-y" target="_blank">dynamAedes</a> is a stochastic, time-discrete, and spatially explicit model designed to simulate the population dynamics of four invasive Aedes species: <em>Aedes aegypti</em>, <em>Ae. albopictus</em>, <em>Ae. japonicus</em>, and <em>Ae. koreicus</em>. The model is driven by factors such as temperature, photoperiod, and larval competition, and it can be applied at three spatial scales: punctual, local, and regional. Key features include</p>
    <ul>
    ...
    <p>The source code, instructions for the installation and examples are available at <a href="https://mattmar.github.io/dynamAedes/">Github</a>
    </p>  

    <h3>Metelmann et al.</h3>
    <p>This model, presented <a href="https://royalsocietypublishing.org/doi/full/10.1098/rsif.2018.0761" target="_blank">here</a>, is a mechanistic model describing the population dynamics of <em>Ae. albopictus</em> using ordinary differential equations. The tiger mosquito populations are divided into five classes (eggs, diapausing eggs, juveniles, immature adults, adults). Specific environmental (human density) and meteorological (daily maximal, mean and minimum temperature, daily rain, photoperiod) drivers affect their survival, fertility and development rates.</p>

    The model's strengths are mainly in its use of instantaneous temperature (which allows to consider its diurnal variation) and the latitude-dependent autumn photocritical period (which allows for adaptation phenomena to be taken into account). The model, originally written in Matlab/Octave can be downloaded in the <a href="https://royalsocietypublishing.org/doi/suppl/10.1098/rsif.2018.0761" target="_blank">supplementary materials</a> of the article. An unofficial R adapted version of the model is available at <a href="https://github.com/radiciandrea/Metelmann2019Model" target="_blank">GitHub</a>.

    <h3>Stacked Machine Learning</h3>
    <p>
    This ensemble machine learning approach allows to combine the estimates of multiple base-learners into a final prediction made by a meta-model. This approach has been used to forecast the weekly abundance of <em>Ae. albopictus</em> eggs (<a href="https://doi.org/10.32942/X2NG70" target="_blank">under review</a>). In the specific case study described in the preprint, the model is driven by environmental covariates, such as temperature, precipitation, photoperiod, urbanisation and spatially explicit ovitrap data. Additionally, the model incorporates Fourier harmonics to explicitly account for temporal patterns, capturing both seasonal cycles and interannual variations.
</p>

    <h3>VECTRI</h3>
    <p>The Vector-borne disease community model of ICTP, TRIeste (VECTRI) is a multi-species climate-aware dynamical model that explicitly resolves the egg, larval and adult female vector densities. Originally developed for <em>Anopheles gambiae s.s.</em> and <em>P. falciparum</em> malaria (<a href="https://link.springer.com/article/10.1186/1475-2875-12-65" target="_blank">Tompkins, 2013</a>), the model now incorporates a parameterization suite for <em>Ae. albopictus</em> (Zornoza et al. 2024), calibrated and validated against bi-weekly ovitrap data from Emilia-Romagna, Italy (<a href="https://onlinelibrary.wiley.com/doi/full/10.1111/j.1948-7134.2011.00147.x" target="_blank">Carrieri et al. 2011</a>, 
        <a href="https://www.tandfonline.com/doi/full/10.1080/20477724.2017.1292992" target="_blank">2017</a>,
        <a href="https://www.tandfonline.com/doi/full/10.1080/20477724.2020.1866375" target="_blank">2020</a>) and spatial occurrence data from <a href="https://elifesciences.org/articles/08347" target="_blank">Kraemer et al. 2015</a> and the Global Biodiversity Information Facility (GBIF). The model for the vector life cycle is coupled to a disease transmission model which currently lacks a description of dengue (DENV) or any other virus vectored by the Asian tiger mosquito.</p>
    
    <p>Useful resources:
        <ul>
            <li>The source code is available at <a href="https://gitlab.com/tompkins/vectri/-/tree/master?ref_type=heads" target="_blank">GitLab</a></li>
            <li>Original <a href="http://users.ictp.it/~tompkins/vectri/manual/" target="_blank">documentation</a> and installation</li>
            <li>Update: Breeding model and Hydrology (<a href="https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0150626" target="_blank">Asare et al. 2016</a>, <a href="https://www.geospatialhealth.net/gh/article/view/390/358" target="_blank">Asare et al. 2016</a>)</li>
            <li>Update: Genetic Algorithm calibration (<a href="https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0200638" target="_blank">Tompkins et al. 2018</a>)</li>
            <li>Update: Forecasting (<a href="https://journals.ametsoc.org/view/journals/apme/54/3/jamc-d-14-0156.1.xml?tab_body=pdf" target="_blank">Tompkins et al. 2015</a>, <a href="https://agupubs.onlinelibrary.wiley.com/doi/full/10.1029/2018GH000157" target="_blank">Tompkins et al. 2019</a>)</li>
            ...
            <li> Run example (<a href="https://osf.io/3gcfb/" target="_blank">OSF repository</a>)</li>
        </ul>
    </p>
